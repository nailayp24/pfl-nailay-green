...
export default function NotFound({ 
  ...
  description = "Maaf, modul data lembar halaman bengkel ini belum dikonfigurasi atau sedang dalam pemeliharaan berkala.", 
      ...
      <div className="bg-white rounded-[40px] shadow-lg max-w-5xl w-full overflow-hidden flex flex-col md:flex-row items-stretch min-h-[480px]">
        ...
        <div className="w-full md:w-3/5 p-12 flex flex-col justify-center">
          <div className="mb-2 flex items-center gap-2">
            ...
            <span style={{ color: color }} className="font-bold tracking-widest uppercase text-xs">Sistem Bermasalah</span>
          </div>
          ...
          <a href="/" style={{ backgroundColor: "#DEE33E" }} className="inline-flex items-center text-black font-extrabold py-4 px-10 rounded-2xl shadow-lg shadow-[#DEE33E]/20 w-fit text-sm">
